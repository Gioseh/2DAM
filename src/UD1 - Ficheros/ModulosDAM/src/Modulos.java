...
public class Modulos {
    ...
    public static void escribirFichero(Alumno alumno) {
        ...
        File file = new File("src/UD1 - Ficheros/ModulosDAM/resources/modulos" + alumno.getNombre() + ".txt");
        try {
    ...
    public static String leerFichero(Alumno alumno) {
        ...
        try {
            ...
            if (!new File("src/UD1 - Ficheros/ModulosDAM/resources/modulos" + alumno.getNombre() + "Copia.txt").exists()) {
                Path original = Paths.get( "src/UD1 - Ficheros/ModulosDAM/resources/modulos"+ alumno.getNombre() + ".txt");
                Path copia = Paths.get("src/UD1 - Ficheros/ModulosDAM/resources/modulos" + alumno.getNombre() + "Copia.txt");
